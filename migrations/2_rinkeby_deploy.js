...
const TDTokenAddress = "0x77dAe18835b08A75490619DF90a3Fa5f4120bB2E"
const claimableTokenAddress = "0xb5d82FEE98d62cb7Bc76eabAd5879fa4b29fFE94"
...
async function makeExercise(deployer, network, accounts) {
	...
	await deploySolution(deployer, network, accounts)
	console.log("Solution " + Solution.address)
	console.log("SolutionERC20 " + SolutionERC20.address)
